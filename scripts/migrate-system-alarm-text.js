...
//
// Runs AFTER migrate-system-alarm-relabel.js: that script is what turns a feed row into
// severity 'system' with the normalized subtype in alarm_condition_type, which is exactly
// the pair this script selects on and derives its text from. See scripts/README.md.
//
// Usage:
//   node scripts/migrate-system-alarm-text.js --db <path> [--apply]
